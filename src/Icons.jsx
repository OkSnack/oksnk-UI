...
import { BoxItem, BoxLine, Btn, TextBtn } from "./style/style-global";
...
const IconList = () => {
  ...
  const handleCopy = async (icon) => {
    try {
      ...
      setCopied(true);
      toast.success(`${icon}, foi copiado com sucesso`, {
        style: { fontSize: "16px" },
      });
  ...
  return (
    <BoxLine direction="column" bg_color="#1111">
      <BoxItem direction="column" justify="start">
        <BoxItem height="5%" margin='16px 0px'>
          <Btn
            height="32px"
            bg_color={click === "FontAwesome" ? "#d6d5d5" : "white"}
            onClick={() => {
              setClicled(iconsFontAwesome), setClick("FontAwesome");
            }}
          >
            {" "}
            <TextBtn color="black" size="16px">
              {" "}
              Font Awesome{" "}
            </TextBtn>{" "}
          </Btn>
          <Btn
            height="32px"
            margin="0px 16px"
            bg_color={click === "Material" ? "#d6d5d5" : "white"}
            onClick={() => {
              setClicled(iconsMaterial), setClick("Material");
            }}
          >
            {" "}
            <TextBtn color="black" size="16px">
          ...
          <Btn
            height="32px"
            bg_color={click === "Ant" ? "#d6d5d5" : "white"}
            onClick={() => {
              setClicled(iconsAntDesign), setClick("Ant");
            }}
          >
            {" "}
            <TextBtn color="black" size="16px">
